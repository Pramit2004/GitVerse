      ...
      >
        ...
        <div style={{ flex:'1 1 300px', minWidth:0 }}>
          ...
          <div style={{ display:'flex', gap:28, flexWrap:'wrap' }}>
            {[{label:'Chapters',val:22},{label:'Commands',val:60,suf:'+'},{label:'Simulators',val:9}].map(s => (
              <div key={s.label}>
      ...
      <section style={{ padding:'clamp(40px,6vw,80px) clamp(16px,4vw,48px)' }}>
        <div style={{ maxWidth:'var(--page-max)', margin:'0 auto' }}>
          <div style={{ textAlign:'center', marginBottom:32 }}>
            ...
            <p style={{ color:'var(--text-muted)', fontSize:15 }}>9 hands-on simulators built into every chapter.</p>
          </div>
